...
namespace UtopiaBackendChallenge.Data
{
    public partial class utopiaContext : DbContext
    {
        public utopiaContext()
        {
        }

        public utopiaContext(DbContextOptions<utopiaContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:backend-dev-test.database.windows.net,1433;Initial Catalog=utopia;Persist Security Info=False;User ID=candidate;Password=FairPayForEveryPlay!");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA905F4164");
